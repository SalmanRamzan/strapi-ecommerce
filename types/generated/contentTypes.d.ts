...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descr: Schema.Attribute.Text;
    dprice: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1000>;
    ...
    price: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1500>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    productRating: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>;
    publishedAt: Schema.Attribute.DateTime;
